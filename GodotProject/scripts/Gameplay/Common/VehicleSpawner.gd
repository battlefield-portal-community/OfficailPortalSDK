...
enum VehicleType_selection {Abrams, Leopard, Cheetah, CV90, Gepard, UH60, Eurocopter, AH64, Vector, Quadbike, GolfCart, Marauder, Flyer60, JAS39, F22, F16, M2Bradley, SU57, UH60_Pax, Marauder_Pax, RHIB}
